...
@section('title', 'Create Company | Trackag')
                                ...
                                <div class="card-body row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="contact_no2"
                                            class="form-control mobile_no @error('contact_no2') is-invalid @enderror"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="file" name="logo"
                                            class="form-control @error('logo') is-invalid @enderror" accept="image/png">
                                        @error('logo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="state[]" class="form-control @error('state') is-invalid @enderror"
                                            multiple>
                                            @foreach ($states as $s)
                                                <option value="{{ $s->id }}" {{ collect(old('state'))->contains($s->id) ? 'selected' : '' }}>
                                                    {{ $s->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="subscription_type"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="tally_configuration"
                                            class="form-select @error('tally_configuration') is-invalid @enderror">
                                            <option value="0" {{ old('tally_configuration') == '0' ? 'selected' : '' }}>No
                                            </option>
                                            <option value="1" {{ old('tally_configuration') == '1' ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                ...
                                <div class="card-body row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="contact_no"
                                            class="form-control mobile_no @error('contact_no') is-invalid @enderror"
