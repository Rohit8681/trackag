...
@section('title', 'Attendance Calendar | Trackag')
                                ...
                                <tr>
                                    ...
                                    @while ($currentDay <= $totalDays)
                                        ...
                                        <td style="vertical-align: top; padding: 8px; min-height: 100px;">
                                            ...
                                            @if (!empty($attendance['trip_type']) && $attendance['trip_type'] !== '-')
                                                <div class="mt-1 text-muted small">Type: {{ ucfirst($attendance['trip_type']) }}</div>
                                            @endif
